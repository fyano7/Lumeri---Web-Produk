  ...
  return (
    <div className="min-h-screen bg-[#fdf8f5] font-sans selection:bg-black selection:text-white">
      ...
      <main className="pt-32 pb-40 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 md:gap-12">
          {PRODUCTS.map((product) => (
            <Link
              ...
              className="group relative bg-white border border-black/5 rounded-[2.5rem] overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 flex flex-col md:flex-row"
            >
              {/* Image side */}
              <div
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center p-8 transition-transform duration-700 group-hover:scale-110 group-hover:-rotate-3">
                  <Image
                    src={product.img}
                    alt={product.name}
                    width={300}
              ...
              <div className="flex-1 p-8 flex flex-col justify-between">
                <div>
                  <h2 className="text-3xl font-black text-black mb-3 group-hover:text-[#e75a40] transition-colors">
                    {product.name}
                  </h2>
                  <p className="text-gray-500 line-clamp-3 text-sm leading-relaxed mb-6 font-medium">
                    {product.desc}
                  </p>
                </div>
                <div className="flex items-center justify-between mt-auto pt-6 border-t border-gray-100">
                  ...
                  <div className="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center transition-transform group-hover:scale-110 group-hover:bg-[#e75a40]">
        ...
        {/* Info Banner */}
        <div className="mt-32 p-12 bg-[#1b2b5b] rounded-[3rem] text-white flex flex-col md:flex-row items-center justify-between gap-10 overflow-hidden relative group">
          ...
          <button className="relative z-10 bg-white text-[#1b2b5b] px-10 py-5 rounded-full font-black text-xl hover:scale-105 transition-transform flex items-center gap-3">
